...
class CapitalOneBankParser(PDFParser):
    def __init__(self) -> None:
        super().__init__([70,272,378, 485, 580])
    ...
    def _parse_row(self, row: List[Any], table_index: int) -> Transaction | None:
        ...
        print(row)
        print(valid_row, bool( valid_row and amount_str != "nan" and (subtraction_amount == 0 or subtraction_amount == "nan")), amount_str, subtraction_amount)
